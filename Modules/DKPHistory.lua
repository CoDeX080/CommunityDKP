	...
	DKPHistTimer:SetScript("OnUpdate", function(self, elapsed)
		...
		if HistTimer > 0.001 and j <= currentLength and not processing then
			...
			if not strfind(dkp, "-") then
				CommDKP.ConfigTab6.history[i].d:SetText("|cff00ff00"..dkp.." "..L["DKP"].."|r - |cff616ccf"..reason.."|r |cff555555("..timeofday..")|r "..L["DKPHISTRECORDBY"].." |c"..c.hex..curOfficer.."|r");
			else
				if strfind(reason, L["WEEKLYDECAY"]) or strfind(reason, "Migration Correction") then
					local decay = {strsplit(",", dkp)}
					CommDKP.ConfigTab6.history[i].d:SetText("|cffff0000"..decay[#decay].." "..L["DKP"].."|r - |cff616ccf"..reason.."|r |cff555555("..timeofday..")|r "..L["DKPHISTRECORDBY"].." |c"..c.hex..curOfficer.."|r");
				else
					CommDKP.ConfigTab6.history[i].d:SetText("|cffff0000"..dkp.." "..L["DKP"].."|r - |cff616ccf"..reason.."|r |cff555555("..timeofday..")|r "..L["DKPHISTRECORDBY"].." |c"..c.hex..curOfficer.."|r");
				end
			end
